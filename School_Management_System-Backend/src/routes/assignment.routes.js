...
import express from 'express';
// ✅ 1. Import the new submissionUpload middleware
...
// This route can use a different upload middleware if needed for teacher uploads
router.post('/upload', authMiddleware, uploadAssignment);

// ✅ 2. Use the new middleware for student submissions
router.post(
  '/submit',
  authMiddleware,
  submissionUpload.single('file'), // Use the correct middleware
  submitAssignment
);
