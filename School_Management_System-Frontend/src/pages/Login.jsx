...
//     try {
//       const loginRoute = `${import.meta.env.VITE_BACKEND_URL}/api/${role}s/login`;
...
//                 type="submit"
//                 disabled={loading}
//                 className={`w-full bg-blue-600 text-white py-3 rounded text-lg font-semibold transition duration-300 ${loading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-blue-700'
//                   }`}
//               >
//                 {loading ? (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-300">
      <div className="flex flex-col md:flex-row max-w-7xl w-full min-h-[80vh] bg-gray-200 rounded-lg shadow-2xl overflow-hidden">
        ...
        <div className="w-full md:w-1/2 relative">
          ...
          {/* ✅ 2. Add the Home icon link here */}
          <Link to="/" className="absolute top-4 left-4 z-10 p-2 rounded-full bg-black/30 text-white hover:bg-black/50 transition-colors">
            <FaHome size={24} />
          </Link>
