...
const CommonProfile = () => {
  ...
  // ✅ FIX: Create a helper function for the image source for clarity
  const getProfileImageUrl = () => {
    if (preview) {
      return preview;
    }
    if (user && user.profileImage) {
      // Always prepend the backend URL if a profile image path exists
        ...
        <div className="max-w-2xl mx-auto bg-white/5 rounded-xl p-6 shadow-lg border border-white/10 mt-6">
          <div className="flex flex-col md:flex-row items-center gap-6 mb-6">
            <div className="relative">
              <div className="w-32 h-32 rounded-full overflow-hidden border-2 border-indigo-500/50 flex items-center justify-center">
                <img
                  // ✅ FIX: Use the new helper function for the src
